import{_ as s,o as n,c as a,Q as p}from"./chunks/framework.d7a29f29.js";const u=JSON.parse('{"title":"搭建vite vue3 threejs开发环境","description":"","frontmatter":{},"headers":[],"relativePath":"articles/threejs环境搭建.md","filePath":"articles/threejs环境搭建.md"}'),l={name:"articles/threejs环境搭建.md"},o=p(`<h1 id="搭建vite-vue3-threejs开发环境" tabindex="-1">搭建vite vue3 threejs开发环境 <a class="header-anchor" href="#搭建vite-vue3-threejs开发环境" aria-label="Permalink to &quot;搭建vite vue3 threejs开发环境&quot;">​</a></h1><h2 id="安装依赖" tabindex="-1">安装依赖 <a class="header-anchor" href="#安装依赖" aria-label="Permalink to &quot;安装依赖&quot;">​</a></h2><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"></span>
